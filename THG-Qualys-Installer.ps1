...
###Envoke Via CMD###
# powershell -command "iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/THG-Bfreitas/It-Scripts/main/THG-Qualys-Installer.ps1'))" 
...
##Executing EXE
 Start-Process -Wait -FilePath C:\temp\QualysCloudAgent.exe -Argument "CustomerId={0fc184d4-664e-73f8-82c6-ef818818f7ca} ActivationId={9516aef8-b335-4e0e-a8b0-f0365452f452} WebServiceUri=https://qagpublic.qg3.apps.qualys.com/CloudAgent/" -PassThru  
